...
import CategorieField.Categorie;
import CategorieField.CategorieSelect;
import Application.ApplicationJavaFx;

public class ProduitEdit extends Application{
		...
		btnModifier.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent t) {
            	try {
                	...
                	Categorie objCat;
                	if(CategorieSelect.categorieSelected != null){
                		objCat = CategorieSelect.categorieSelected;
                	}else{
