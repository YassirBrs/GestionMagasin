...
import ProduitField.ProduitAdd;
import ProduitField.ProduitEdit;

public class CategorieSelect extends Application{
			...
			row.setOnMouseClicked(event->{
				try {
					if (event.getClickCount() == 2 && (!row.isEmpty())) {
						...
						ProduitAdd.txtCategorie.setText(categorieSelected.getIntitule()+"");
						ProduitEdit.txtCategorie.setText(categorieSelected.getIntitule()+"");
